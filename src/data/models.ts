...
export const BASE_MODELS: BaseModelInfo[] = [
  {
    ...
    huggingFaceId: "unsloth/Qwen-3.8B-Instruct",
    ollamaName: "qwen3.8",
    ...
    baseSizeGb: 7.6,
    q4SizeGb: 2.4,
    description: "Ultra-compact 3.8B parameters Qwen model. Extremely fast QLoRA fine-tuning and lightweight execution.",
    recommendedFor4080Super: true,
  },
  {
    id: "qwen-2.5-coder-32b",
    name: "Qwen 2.5 Coder 32B Instruct",
    huggingFaceId: "unsloth/Qwen2.5-Coder-32B-Instruct",
    ollamaName: "qwen2.5-coder:32b",
    parametersBillion: 32.5,
    layers: 64,
    hiddenDim: 5120,
    heads: 40,
    kvHeads: 8,
    ...
    baseSizeGb: 65.0,
    q4SizeGb: 19.8,
    description: "SOTA 32B coding & reasoning foundation. Expert pruned & harness tuned for zero-hesitation execution.",
    recommendedFor4080Super: true,
  },
  {
    id: "llama-3.1-8b",
